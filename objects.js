...
//      this.text.setAttribute("y",top+0.2*lineHeight);
  ...
  function drawLink(d,s,t){
    ...
    function event(d){
      ...
      out.box.setAttribute("class","event pwLine");
	  //out.text = document.createElementNS(svg,"text");
	  //out.text.appendChild(document.createTextNode(d.label));
	  //out.text.setAttribute("class","event line");
	  //out.text.setAttribute("font-size",0.8*lineHeight);
	  //out.box.appendChild(out.text);
